...
public class Msg
{
    ...
    {
        limpatela();
        msg_central("Menu Consulta - Escolha a sua opção");
        msg_nl("1. Geral");
    ...
    //           relacionadas às listas
    //
    public static void menu_principal(String titulo)
    {
        limpatela();
        msg_central("Menu Principal - Escolha a sua opcao para a lista ["+titulo+"]:");
    ...
    {
        limpatela();
        msg_central("Menu Principal - Escolha a lista");
        msg_nl("                                  01. Alunos");
        msg_nl("                                  02. Cursos");
        msg_central("00. Finalizar");
    }
    ...
    //
    public static int opcao_principal(String titulo)
    {
        Scanner s = new Scanner(System.in);
        int opc  = 0;
        int erro = 0;
    ...
    public static int opcao_lista()
    {
        ...
        {
            menu_lista();
            msg_nl ("Opção de lista inválida, corrija: ");
